...
class Home extends React.Component {
    ...
    fetchData = (e) => {
            ...
            this.setState({employeeID:'',loader:true},()=>{
                this.props.employeeAction(employeeID);
            })
    }
    ...
    render() {
        ...
        return <div>
          ...
          <DropDownComponent placeHolder="SELECT DEPARTMENT" onChangeEvent={this.onChangeEvent} data={[{key:'',text:'SELECT DEPARTMENT'},{key:'hr',text:'HR'},{key:'employee',text:'Employee'}]} id='department' keys={this.state.keyDepartment+'_dep'} label="Department"/>
          <DropDownComponent placeHolder="SELECT EMPLOYEE ID" onChangeEvent={this.onChangeEvent} data={this.state.department?this.dropdownData[this.state.department]:[]} keys={this.state.keyEmployee+'_emp'} id='employee' label="Employee Id"/>
         ...
         {this.state.loader?<UserCard userDetails={this.props.employeeData}/>:''}
     </div>
        </div>    
         </div>
